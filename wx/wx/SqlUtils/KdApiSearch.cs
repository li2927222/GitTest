...
namespace wx.SqlUtils
{
    ...
    {
        private static string EBusinessID = "1289663";
        //电商加密私钥，快递鸟提供，注意保管，不要泄漏
        private static string AppKey = "a312239e-0555-469c-a226-7609ec863ef5";
        //请求url
        ...
        /// </summary>
        /// <returns></returns>
        public static string getOrderTracesByJson(string sfbill)
        {
            string requestData = "{'OrderCode':'','ShipperCode':'SF','LogisticCode':'" + sfbill + "'}";
