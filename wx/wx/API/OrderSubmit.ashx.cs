...
namespace wx.API
{
    ...
    /// OrderSubmit 的摘要说明
    /// </summary>
    public class OrderSubmit : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //  sp[0]= new SqlParameter("@cus_id", "0210016");

            //   sp[1] = new SqlParameter("@t_memo", "测试");
            DataTable dr = SqlUtils.MSSQLHelper.PrecedureDs("wx_place_order", sp);
